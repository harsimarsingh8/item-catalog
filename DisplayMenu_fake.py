...
restaurant1 = Restaurant(id=1, name='Uncle jacks', image='https://pbs.twimg.com/media/Cu7Z4toUIAAx5bI.jpg', description='Awesome place')
session.add(restaurant1)
session.commit()


restaurant2 = Restaurant(id=2, name='keventers', image='https://content4.jdmagicbox.com/comp/bangalore/k7/080pxx80.xx80.170407082326.i1k7/catalogue/keventers-new-bel-road-bangalore-milk-shake-retailers-1wjnylj.jpg', description='Awesome place')
session.add(restaurant2)
session.commit()


restaurant3 = Restaurant(id=3, name='Beer cafe', image='https://content1.jdmagicbox.com/comp/delhi/n2/011pxx11.xx11.140529115354.n3n2/catalogue/the-beer-cafe-nehru-place-delhi-fine-dining-restaurants-rs-1000-to-rs-2000-2l9mtno.jpg'
                       , description='Awesome place')
session.add(restaurant3)
session.commit()


restaurant4 = Restaurant(id=4, name='Starbucks', image='https://cdn.pixabay.com/photo/2016/02/20/05/10/starbucks-1211620_960_720.jpg', description='Awesome place')
